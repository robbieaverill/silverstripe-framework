    ...
    public function testTemplateTranslation()
    {
        ...
        $provider->getTranslator()->addResource(
            ...
            [
                ...
                'i18nTestModule.ss.PLACEHOLDERNONAMESPACE' => 'My replacement no namespace: {replacement}',
                'i18nTestModule.LAYOUTTEMPLATE' => 'Layout Template',
                'i18nTestModule.ss.LAYOUTTEMPLATENONAMESPACE' => 'Layout Template no namespace',
                'i18nTestModule.PLACEHOLDERNAMESPACE' => 'My replacement: {replacement}',
                ...
                'i18nTestModuleInclude.ss.PLACEHOLDERINCLUDENAMESPACE' => 'My include replacement: {replacement}',
                'i18nTestModuleInclude.ss.PLACEHOLDERINCLUDENONAMESPACE' => 'My include replacement no namespace: {replacement}'
            ],
            'en_US'
        );
        ...
        $provider->getTranslator()->addResource(
            ...
            [
                ...
                'i18nTestModule.ss.PLACEHOLDERNONAMESPACE' => 'TRANS My replacement no namespace: {replacement}',
                ...
                'i18nTestModule.PLACEHOLDERNAMESPACE' => 'TRANS My replacement: {replacement}',
                ...
                'i18nTestModuleInclude.ss.PLACEHOLDERINCLUDENAMESPACE' => 'TRANS My include replacement: {replacement}',
                'i18nTestModuleInclude.ss.PLACEHOLDERINCLUDENONAMESPACE' => 'TRANS My include replacement no namespace: {replacement}',
