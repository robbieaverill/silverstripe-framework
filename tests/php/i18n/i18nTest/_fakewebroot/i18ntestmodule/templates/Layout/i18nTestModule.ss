...
<%t i18nTestModule.PLACEHOLDERNAMESPACE "My replacement: {replacement}" replacement=$TestProperty %>
<%t PLACEHOLDERNONAMESPACE "My replacement no namespace: {replacement}" replacement=$TestProperty %>
